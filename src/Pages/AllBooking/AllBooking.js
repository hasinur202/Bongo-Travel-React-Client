...
const AllBooking = () => {
    ...
    useEffect(() => {
        const url = 'https://bongo-travel.herokuapp.com/all-bookings';
        fetch(url)
            .then(res => res.json())
    ...
    if (proceed) {
        const url = `https://bongo-travel.herokuapp.com/approve-booking/${id}`;
        fetch(url, {
            method: 'PUT'
        })
            .then(res => res.json())
...
// Reject Booking AN USER
    ...
    if (proceed) {
        const url = `https://bongo-travel.herokuapp.com/reject-booking/${id}`;
        fetch(url, {
            method: 'PUT'
        })
            .then(res => res.json())
